...
def mildew_detector():
    st.info(
        f"* The client wants a tool for telling whether a leaf is "
        f"infected by mildew or is healthy"
    )

    st.write(
        f"* A downloadable set of the infected "
        f"and healthy samples for live testing "
        f"is available"
